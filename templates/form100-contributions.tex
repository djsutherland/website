...
{%- set sections = [
  ...
  ["Low-acceptance-rate conference papers", ["conference"]],
  ["Papers under submission to low-acceptance-rate conferences", ["preprint"]],
  ["High-acceptance-rate and non-refereed contributions", ["workshop", "poster", "tech-report"]],
] -%}
