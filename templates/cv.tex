...
\documentclass[11pt,palatino]{moderncv}
...
\renewcommand{\firstnamefont}{\huge}
...
\usepackage[maxbibnames=9,doi=false,sorting=none,style=authortitle,dashed=false]{biblatex}
...
\newcommand{\class}[2]{#1 {\scriptsize (#2)}}
...
\cventry{2016}{Ph.D., Computer Science}{Carnegie Mellon University}{}{}{%
  ...
  %   \class{Computational Models of Neural Systems}{A},
  %   \class{Semantics of Programming Languages}{A+},
  %   \class{Graduate Algorithms}{A-},
  %   \class{Optimization}{A+},
  %   \class{Intermediate Statistics}{A+},
  %   \class{Optimizing Compilers for Modern Architectures}{A},
  %   \class{Deep Learning}{A}.% \\
}
...
\cventry{2011}{B.A., Computer Science}{Swarthmore College}{}{with high honors}{%
    ...
    % \emph{Selected coursework}: Artificial Intelligence, Natural Language Processing, Adaptive Robotics, Data Management Systems; Linguistic Typology, Structure of ASL, Syntax, Phonetics \& Phonology, Sociolingustics; Probability Theory, Mathematical Statistics, Real Analysis, Modern Algebra.
}
...
% \cvline{Dec 2012}{10-725 Optimization course: best poster award.}
...
\cventry{Summer 2010}{REU in machine learning}{University of Oklahoma}{}{}{%
    Worked on a relational concept learning system with Andrew Fagg.
     % Made algorithmic improvements to the learning process and incorporated several kinds of knowledge from a human trainer, as well as dramatically improving the implementation. Continued work through June 2011 as a BA thesis.
}
