...
% UBC rules: 150 words max
  ...
  \changed{I am the first person other than Mark Schmidt to teach the current form of this course.
...
\begin{coursetable}
  \newtable 23-24 W2  & CPSC 440+550 & 3 & 105+25        & 3/week  & 1h/week office hours \\
...
including improved tools for their empirical study \parencite{mohamadi:pseudo-ntk},
...
Work with related tools has also contributed to understanding the grokking phenomenon (a hotly-studied problem in learning theory) \parencite{mohamadi:grokking},
and to deepen foundational understanding of learning theory in high-dimensional regimes
\parencite{zhou:moreau,zhou:optimistic-rates,koehler:gaussian-interpolators}.
}

\paragraph{Improved techniques based on theoretical insights.}
Our theoretical insights have also led to improved models for
learning on graph data (such as molecular graphs and citation networks) \parencite{shirzad:exphormer,shirzad:sparsifying-exphormer},
private generative models \parencite{harder:dp-mepf,yang:dp-ntk},
weakly-supervised semantic segmentation \parencite{bae:prediction-filtering},
and the closely related problems of improving out-of-distribution generalization and fairness \parencite{ren:sem-il,pogodin:circe,deka:mmd-bfair}.
...
\begin{itemize}[leftmargin=5em]
  \item[2020-24] \changed{Area Chair, Conference on Artificial Intelligence and Statistics (AISTATS).}
