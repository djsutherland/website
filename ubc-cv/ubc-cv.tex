% Danica's UBC CV
% Adapted from Kwang Moo Yi's and Kevin Leyton-Brown's CVs,
...
\noindent
\rule{3.44in}{0mm}%
\parbox[t]{2in}{{\bf Date:} \today}%
\parbox[t]{1in}{Initials: DJS}%
\\[5mm]
\noindent\parbox[t]{.44in}{{\bf 1.}\hfill\mbox{}}%
\parbox[t]{3in}{{\bf SURNAME:} Sutherland}%
\parbox[t]{3.2in}{{\bf FIRST NAME:} Danica}%
\\%
\rule{3.44in}{0mm}%
\parbox[t]{3.45in}{{\bf MIDDLE NAME:} Jane}
\\[5mm]
...
\parbox[t]{.44in}{{\bf 4.}\hfill\mbox{}}\parbox[t]{3in}{{\bf PRESENT RANK:}
  Assistant Professor}\parbox[t]{3in}{{\bf SINCE:} December 2020} \\[5mm]
...
\begin{table}[h!]
  ...
  \begin{tabular}{ p{0.725\textwidth} p{0.20\textwidth} }
    ...
    \midrule
    Associate Professor               & 2026/07 --         \\
    Assistant Professor               & 2020/12 -- 2026/06        \\
    \bottomrule
  \end{tabular}
\end{table}

\vspace{-1em}
\subsection{Date of granting of tenure at UBC: \textmd{July 1, 2026}.}
...
\begin{table}[h!]
  \begin{tabular}{ p{0.36\textwidth} p{0.40\textwidth} p{0.13\textwidth} }
    ...
    %\multicolumn{1}{c}{\bf Rank or Title} & \multicolumn{1}{c}{\bf Dates} \\
    %\midrule
    Associate Professor, Computer Science & University of British Columbia  & 2026 --         \\
    Assistant Professor, Computer Science & University of British Columbia  & 2020 -- 2026    \\
...
% UBC rules: 150 words max
  ...
  \paragraph{Redesign of undergraduate machine learning curriculum.}
  \new{%
  After spending several years modernizing and reworking CPSC 440,
  I proposed and am developing a new course AI 240: Introduction to Machine Learning,
  aimed to eventually be a core course for all computer science undergraduates.
  I will teach the first offering of this course in 2026W2,
  and then design and teach the first offering of its sequel,
  AI 340, probably in 2027W1.
  }

  %\paragraph{Updates of CPSC 440/550: Advanced Machine Learning}
  %\continuing{}I inherited this course in a state of having been ``partially'' converted from a graduate course to an undergraduate one.
  %I have substantially modernized, reorganized, and reworked the course material,
  %as well as standardizing the programming tools used in the assignments
  %and introduced pedagogical changes such as introducing biweekly quizzes with the Computer-Based Testing Facility.

  \paragraph{Design of CPSC 532D: Modern Statistical Learning Theory.}
  \continuing{}
  This graduate course
  %(in a mostly lecture-oriented format, due to the quantity of necessary content) focuses on
  gives students the broad background in learning theory
  required for mathematical understanding of machine learning methods.
  The course integrates material from several textbooks and other courses
  with multiple lectures of material from research papers published in the last five years.
  %I combined materials from several textbooks and notes sets with significant extra material from current research papers to not only cover traditional topics developed in the 70s and 80s, but also bring them up to speed on current developments, with multiple lectures devoted almost exclusively to papers published since 2018.
  ...
  My lecture notes, much-appreciated by the students,
  cover these varied topics in a way that strives to be accessible while also correcting mistakes in the literature.
...
\begin{coursetable}
  \newtable 25-26 W2  & CPSC 440+550 & 3 & 140+17        & 3/week  & 1h/week office hours \\
  \newtable 25-26 W1  & CPSC 532D    & 3 & 17            & 3/week  & 1h/week office hours \\
            24-25 W2  & CPSC 440+550 & 3 & 67+22         & 3/week  & 1h/week office hours \\
            24-25 W1  & CPSC 532D    & 3 &  9            & 3/week  & 2h/week office hours \\
            23-24 W2  & CPSC 440+550 & 3 & 96+16         & 3/week  & 1h/week office hours \\
            23-24 W1  & CPSC 532D    & 3 & 15            & 3/week  & 2h/week office hours \\
            22-23 W2  & CPSC 440+540 & 3 & 69+30         & 3/week  & 1h/week office hours \\
            22-23 W1  & CPSC 532D    & 3 & 22            & 3/week  & 1h/week office hours \\
            21-22 W2  & CPSC 532S    & 3 & 23            & 3/week  & 2h/week office hours \\
            21-22 W1  & CPSC 340     & 3 & 89\textit{\small +139} & 3/week  & 1h/week office hours \\
\end{coursetable}
\tremark{%
CPSC 440 and 550 (previously 540) are undergraduate and graduate cross-listings of one course; sizes show the enrolment in each listing.\\
...
\begin{suptable}
  \changedtable    Bingshan Hu   & Postdoc, UBC CS & 2023/11 & 2025/11 & M.\ Lécuyer, T.\ Campbell \\
\end{suptable}
%\tremark{%
%  Bingshan is co-supervised with Mathias Lécuyer and Trevor Campbell; I provide the majority of her funding.
%}

\paragraph{PhD Supervision}
%\footnotetext[1000]{Switched to my supervision at this point.}% XXX idk why this is necessary, blegh
\begin{suptable}
  ...
  \changedtable    Yi Joshua Ren & PhD, UBC CS & 2020/09 & 2025/09 & -- \\
  \changedtable    Wonho Bae     & PhD, UBC CS & 2020/09 & 2025/08 & -- \\
\end{suptable}
\tremark{%
  %Matthew and Yao are incoming students, with the current plan being fully shared supervision and funding.\\
  %Ke is funded and primarily supervised by Chao Liu.\\
  Joshua moved on to an internship at Cohere and then a postdoc at Oxford with Yarin Gal.\\
  Wonho moved on to a research job at Apple and then at Amazon.
}
 
\paragraph{MSc Thesis Supervision}
\begin{suptable}
                Aaron Wei             & MSc, UBC CS & 2026/09 & ongoing & --  \\
                Mohamad Amin Mohamadi & MSc, UBC CS & 2021/05\switched{} & 2023/04 & --  \\
  %                                    & Researcher  & 2023/05 & 2024/01 & Supervisor  \\
                Namrata Deka          & MSc, UBC CS & 2020/09 & 2023/04 & --    \\
  %                                    & Researcher  & 2023/05 & 2023/08 & Supervisor  \\
                Milad Jalali          & MSc, UBC CS & 2020/09 & 2023/08 & --    \\
\end{suptable}
\tremark{%
  Mohamad Amin and Namrata, after graduating,
  continued for some time in non-student research positions (Mohamad Amin for eight months, Namrata for three);
  they then began PhDs at TTI-Chicago and Carnegie Mellon, respectively.\\
  Milad moved on to a job at Vancouver biomedical imaging company Prenuvo.
}


%\iftoggle{ubcformat}{\clearpage}{} % XXX TEMP
\paragraph{PhD Supervisory Committee Memberships}
\begin{supcommtable}
  \continuingtable Saeid Naderiparizi     & PhD, UBC CS       & 2026/02 & ongoing & PhD committee member \\
  \continuingtable Puneesh Deora          & PhD, UBC ECE      & 2025/08 & ongoing & PhD committee member \\
  \continuingtable Qiaoyue Tang           & PhD, UBC CS       & 2025/06 & ongoing & PhD committee member \\
  \newtable        Seungyeon Baek         & PhD, UBC CS       & 2026/07 & ongoing & PhD committee member \\
                   Chen Fan               & PhD, UBC CS       & 2025/03 & 2025/12 & PhD committee member \\
                   Vasileios Lioutas      & PhD, UBC CS       & 2024/09 & 2025/04 & PhD committee member \\
  \continuingtable Tina Behnia            & PhD, UBC ECE      & 2024/08 & ongoing & PhD committee member \\
                   Victor Portella        & PhD, UBC CS       & 2023/01 & 2024/07 & PhD committee member \\
\end{supcommtable}

\paragraph{Research Proficiency Exam Committee Memberships}
\begin{supcommtable}
                   Donney Fan             & PhD, UBC CS       & 2025/09 & 2025/11 & RPE committee member \\
                   Yabing Qi              & PhD, UBC CS       & 2025/05 & 2025/08 & RPE committee member \\
...
\end{supcommtable}
\tremark{%
  The RPE is a step in the degree for PhD students at UBC CS roughly corresponding to a qualifying exam.
}

\paragraph{MSc Committee Memberships}
\begin{supcommtable}
  \changedtable    Alan Milligan          & MSc, UBC CS       & 2023/09 & 2025/09 & MSc committee member \\
...
\begin{suptable}
                Anubhav Garg  & MSc (essay), UBC CS & 2022/10\switched{} & 2024/04 & -- \\
                Arsh Jhah     & MSc (essay), UBC CS & 2022/06\switched{} & 2023/10 & -- \\
\end{suptable} \label{sec:other-sup}
\tremark{%
  Arsh and Anubhav both came to me as essay-option students, switching from other advisors, rather than switching from a research program under my supervision. {\color{white} \switched}
}
...
\paragraph{Undergraduate Research Supervision}
\begin{usuptable}
  \newtable   Mohamad Bazzi  & Summer research intern                                & 2025/05 & 2025/08\\
              Aaron Wei      & CPSC 449 (Honours thesis)                             & 2024/09 & 2025/04 \\
  \newtable                  & Summer research intern (enSURE, AML-TN funding)       & 2025/05 & 2025/08 \\
  \newtable                  &        Research intern                                & 2025/09 & 2025/05 \\
              Achinth Bharadwaj & Science Undergraduate Research Experience (SURE)   & 2023/06 & 2023/08 \\
\end{usuptable}
\tremark{%
  Mohamad worked on active learning, particularly as applied to selective annotation in large language models. After finishing his undergrad at American University in Beirut, he is beginning a master's program at Carnegie Mellon.\\
  Aaron's thesis focused on the theoretical foundations of statistical measures of conditional independence, and he continued to work on statistical properties of kernel distribution distances and conditional independence. He will continue on with me as a PhD-track student.\\
  Achinth worked on a research project titled ``Demographic representativeness via kernel distribution distances''; he went on to industry jobs, currently at a startup.
}
...
% 
%My lab's work broadly spans representation learning, statistical testing, learning theory, and understanding probability distributions.
%A few recent focus areas:
...
% Much of my lab's work is based on improving understanding of how modern deep learning methods work.
% Recent advances include
% \new{an explanation for a widely observed but not well-understood failure mode of the direct preference optimization algorithm for large language model alignment \parencite{ren:llm-dynamics}},
% and \new{a much sharper theoretical understanding of the hotly-discussed ``grokking'' problem \parencite{mohamadi:grokking}},
% which both built off earlier work advancing the theoretical use and applications of neural tangent kernels \parencite{mohamadi:pseudo-ntk,ren:finetuning,ren:learning-path,mohamadi:active-ntk,yang:dp-ntk}.
% 
% \paragraph{Improved techniques based on theoretical insights.}
% Our theoretical insights have also led to improved models for
% learning on graph data (such as molecular graphs and citation networks)
% \iftoggle{annualReview}{\new{\parencite{shirzad:spexphormer,shirzad:spexphormer-compression}} \parencite{shirzad:exphormer}}{\parencite{shirzad:spexphormer,shirzad:spexphormer-compression,shirzad:exphormer}}
% and satisfyingly elegant state-of-the-art methods for active learning \new{\parencite{bae:u-herding,bae:maxherding,bae:active-meta}}.
% Ongoing work also has a particular focus on statistical tools for detecting and avoiding the closely-related problems of predictor unfairness and brittleness to domain shifts \parencite{ren:sem-il,pogodin:circe,deka:mmd-bfair}.
% 
% 
% weakly-supervised semantic segmentation \parencite{bae:prediction-filtering},
% and the closely related problems of improving out-of-distribution generalization and fairness \new{\parencite{ren:sem-il}} \parencite{pogodin:circe,deka:mmd-bfair}.
...
\iftoggle{ubcformat}{%
  ...
  & Empirically Understanding Deep Learning with Theory\competitive{} %&C
  ...
  \continuingtable
  NSERC, CREATE
  & Advanced Machine Learning Training Network\competitive %&C
  ...
  \continuingtable
  NSERC + FRQNT, NOVA
  & Towards Improved Understanding and Efficient Utilization of Depthwise Computation in Modern Neural Networks\competitive{} %& C
  & \$75,000 & 2023--26
  & G.~Wolf; \textit{E.~Belilovsky; D.~J.~Sutherland; J.~Tian}
  \\ \midrule
  UBC Data Science Institute, Postdoctoral Matching Fund
  & Anytime-Valid PAC-Bayes for Industrial Applications\competitive{} %& C
  & \$40,000 & 2023--24
  ...
  \\ \midrule
  \continuingtable
  CIFAR  & Canada CIFAR AI Chair, Amii\competitive{} % & C
  & \$78,333 & 2021--26 & D.~J.~Sutherland
  \\ \midrule
  \continuingtable
  NSERC Discovery & Learning Better Representations with Kernels\competitive{} % & C
  & \$29,000 & 2021--27 & D.~J.~Sutherland
  \\ \midrule
  NSERC Discovery & Launch Supplement % & NC
  & \$12,500 & 2021 & D.~J.~Sutherland
  \\ \midrule
  UBC  & Startup Fund %& NC 
  & \$200,000 & 2020  & D.~J.~Sutherland \\
\end{granttable}
%\tremark{Under the header ``Comp'', C refers to competitive grants and NC to non-competitive.}
...
\begin{itemize}[leftmargin=5em]
  \item[2026] \new{Organizer, Workshop on Hypothesis Testing (\httpsurl{testing.ml}) at the International Conference on Machine Learning (ICML).}
  \item[2026] \new{Panelist, \emph{What Does Research Look Like in the Presence of AI Tools?}, Women in Machine Learning Symposium at the International Conference on Machine Learning (ICML).}
  \item[2026] \new{Area Chair, International Conference on Machine Learning (ICML).}
  \item[2026] \new{Area Chair, International Conference on Learning Representations (ICLR).}
  \item[2020-26] \continuing{Area Chair, Conference on Artificial Intelligence and Statistics (AISTATS).}
  \item[2025-26] \continuing{Area Chair, Conference on Neural Information Processing Systems (NeurIPS).}
...
\begin{itemize}[leftmargin=5em]
  \item[2025--27] \continuing{Curriculum Renewal Committee, Computer Science Department.}
  \item[2025--27] \continuing{AI Undergraduate Programs Committee, Computer Science Department.}
...
\begin{itemize}[leftmargin=5em]
  \item[2026] \new{University Examiner: Kenny Chiu (PhD, Statistics).}
  \item[2025] \new{University Examiner: Zuheng David Xu (PhD, Statistics).}
  \item[]     {Internal review for CFI JELF applications.}
  \item[2024] Chair of thesis proposal exam: William Harvey, Muchen Li, Wanxin Li.
  \item[2023--] \continuing{Recruitment Chair, Advanced Machine Learning Training Network.}
...
\begin{itemize}[leftmargin=5em]
\item[2025] {Canadian Artificial Intelligence Association Best Thesis Award Committee, member.}
...
\begin{itemize}[leftmargin=5em] 
\item[2026--] \new{Action Editor, Transactions on Machine Learning Research (TMLR).}
\end{itemize}
...
\begin{itemize}[leftmargin=5em]
  \item[2026] Conference reviewing: \new{COLT}.
  \item[] Grant reviewing: German Research Foundation (DFG).
  \item[2025] Conference reviewing: \continuing{ICML, NeurIPS, ICLR}.
  %\item[] Journal reviewing: \new{Information and Inference: A Journal of the IMA}.
  \item[2024] Conference reviewing: \continuing{ICML, NeurIPS, ICLR}.
  \item[2024] Conference reviewing: ICML, \continuing{ICLR}.
...
\begin{extcomtable}
             2024 & Ankit Vani & Université de Montréal / Mila & Doctoral \\
             2024 & Kiarash Zahirnia & Simon Fraser University & Doctoral \\
...
\begin{itemize}[leftmargin=5em]
    \item[] Letters from the Dean of the Faculty of Science for ``some of the highest student evaluations in the Faculty of Science'' for: CPSC 340 in 2021W1, CPSC 532S in 2021W2, CPSC 532D in 2024W1.
\end{itemize}
%}%
...
NeurIPS, ICML, and ICLR are considered the ``main three'';
AISTATS and COLT are also primary venues in my subfield.
...
TMLR is a newer journal that publishes work similar to the main conferences.
...
\ifboolexpr{togl{ubcformat} and not togl{annualReview}}{
  ...
  \newrefcontext[labelprefix=P]
  \printbibliography[heading=none,filter=prep]
}{
  \nasection{\ulsection{WORK SUBMITTED}

  Not applicable.}

  \nasection{\ulsection{WORK IN PROGRESS}
