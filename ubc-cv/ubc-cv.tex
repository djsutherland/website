...
\tremark{%
  ...
  Joshua is currently doing an internship at Cohere and then will begin a postdoc at Oxford with Yarin Gal.\\
...
\begin{usuptable}
  ...
  \newtable   Aaron Wei      & CPSC 449 (Honours thesis)                             & 2024/09 & 2025/04 \\
...
\end{usuptable}
\tremark{%
  Mohamad worked on active learning, particularly as applied to selective annotation in large language models.\\
  Aaron's thesis focused on the theoretical foundations of statistical measures of conditional independence, and is continuing to work on statistical properties of kernel distribution distances and conditional independence.\\
