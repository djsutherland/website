...
%\begin{suptable}
  \continuingtable Mohamad Amin Mohamadi & MSc, UBC CS & 2021/05\switched{} & ongoing & Supervisor    \\
...
\end{suptable}
\tremark{%
  Mohamad Amin, Namrata, and Milad all expect to finish in the immediate future,
  with Namrata going on to a PhD at Carnegie Mellon,
  Mohamad Amin deciding between a PhD here and at TTI-Chicago,
  and Milad still deciding on future plans.
}
%  \hdashline
...
\begin{itemize}[leftmargin=5em]
  \item[2023] \new{UBC Women in Science mentorship program}, currently occasionally meeting two first-year undergraduates.
  \item[2023] \new{Chair of thesis proposal exam: Christian Weilbach.}  % XXX Shih-Yang Su
...
% and more.
\item[2021--23] \continuing{Name Change Policy Working Group, member.} \remark{This loosely-organized group (no formal positions) advocates with scientific publishers for post-publication name change policies. \new{I gave two invited talks on these issues in 2022-23.}}
\end{itemize}
% Not applicable.
%}%
