...
% UBC rules: 150 words max
  ...
  \changed{In the second offering this year, I significantly further developed the course, including a format change (from slides to board with lecture notes) and changed the material.}
...
\end{suptable}
\tremark{%
  Mohamad Amin, Namrata, and Milad all expect to graduate in a few months,
  with Namrata expecting to go on to a PhD at Carnegie Mellon
  and the other two still deciding on future plans.
}
%  \hdashline
...
\begin{supcommtable}
  \newtable Amrutha Ramesh         & PhD, UBC CS       & 2022/09 & 2022/11 & RPE committee member    \\
  \newtable Victor Portella        & PhD, UBC CS       & 2023/01 & ongoing & PhD committee member \\
\end{supcommtable}
...
\tremark{%
  Arsh and Anubhav both came to me as essay-option students (rather than switching from a research program);
...
\continuing{
One trend in my lab's recent work is new applications of neural tangent kernel theory  for practical improvements in deep learning \parencite{ren:finetuning,mohamadi:active-ntk}.
Work has also continued on the foundations of learning theory for high-dimensional regimes,
...
\begin{itemize}[leftmargin=5em]
  \item[2020-23] \changed{Area Chair, Conference on Neural Information Processing Systems (NeurIPS).}
  \item[2020-23] \changed{Area Chair, Conference on Artificial Intelligence and Statistics (AISTATS).}
  \item[2022] \new{Panel Moderator, \emph{Faculty and Queerness}, Queer in AI NeurIPS workshop.}
...
Progress is slow,
but since I changed my legal name in 2022 it's been harder for me to find more instances.
}
...
\begin{itemize}[leftmargin=5em]
  \item[2023] \new{AIM-SI Steering Committee} (temporary position as a leave replacement).
  \item[2023] \new{Graduate Recruiting and Admissions Committee, Computer Science Department.}
...
\begin{itemize}[leftmargin=5em]
  \item[2023] \new{Chair of thesis proposal exam: Christian Weilbach.}
  \item[2022] \new{Chair of thesis proposal exam: Vaden Masrani.}
\end{itemize}
%}%
...
\begin{itemize}[leftmargin=5em]
\item[2022--23] \continuing{Queer in AI, core organizer.} \remark{%
...
% and more.
\item[2021--23] \continuing{Name Change Policy Working Group, member.} \remark{This loosely-organized group (no formal positions) advocates with scientific publishers for post-publication name change policies. I gave two invited talks on these issues in 2022-23.}
\end{itemize}
% Not applicable.
%}%
...
\begin{itemize}[leftmargin=5em]
\item[2022-23] \new{CIFAR Pan-Canadian AI Strategy's National Program Committee, member.}
\end{itemize}
% Not applicable.
%}%
...
\begin{itemize}[leftmargin=5em]
  \item[2023] Conference reviewing: \continuing{ICLR}.
  \item[2022] Journal reviewing: \continuing{JMLR}.
...
Although a deeply flawed metric, Google Scholar's h5-index (as of April 2023) lists ICLR as \#9, NeurIPS as \#10, and ICML as \#19 among all publication venues in \emph{any} field.

\paragraph{Citation metrics.}
\input{ubc-cv-citation-info.tex}
Citation metrics are from Google Scholar as of \citeupdatedate{}.
In total, those metrics show my work has been cited \totalcites{} times,
with an $h$-index of \hindex{}, and \itenindex{} papers with at least ten citations.
Images below mark highly-cited papers (thresholds: 10, 50, 100, 500).
