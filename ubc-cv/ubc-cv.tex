...
% UBC rules: 150 words max
  ...
  \paragraph{Update of CPSC 440/550: Advanced Machine Learning}
  \changed{I am the first person other than Mark Schmidt to teach this course.
  I have continued to modernize the topics covered in the course and the assignments
  (switching to further integrated use of modern standard tools),
  as well as pedagogical changes such as introducing biweekly quizzes with the Computer-Based Testing Facility (I believe the first AI course to do so).}
...
\begin{coursetable}
  \newtable 23-24 W2  & CPSC 440+550 & 3 & 96+16        & 3/week  & 1h/week office hours \\
  \newtable 23-24 W1  & CPSC 532D    & 3 & 15            & 3/week  & 2h/week office hours \\
...
\tremark{%
  ...
  continued for some time in non-student research positions,
  before beginning their PhDs at
  TTI-Chicago and Carnegie Mellon, respectively.
  Milad is currently seeking an industry job.
}
%  \hdashline
...
%  \newtable        Wanxin Li              & PhD, UBC CS       & 2024/11 & ongoing & PhD committee member \\
  \newtable        Vasileios Lioutas      & PhD, UBC CS       & 2024/09 & ongoing & PhD committee member \\
...
%  \newtable        Saiyue Lyu             & PhD, UBC CS       & 2024/06 & ongoing & PhD committee member \\
  \newtable        Seungyeon Baek         & PhD, UBC CS       & 2024/05 & 2024/07 & RPE committee member \\
  \continuingtable Victor Portella        & PhD, UBC CS       & 2023/01 & 2024/07 & PhD committee member \\
                   Shadab Shaikh          & MSc, UBC CS       & 2024/03 & 2024/04 & MSc committee member \\
...
Many aspects of my lab's work are based on improving understanding of how modern deep learning methods work.
One particular trend is in new uses for neural tangent kernels,
including improved tools for their empirical study \new{\parencite{mohamadi:pseudo-ntk}},
applications to theoretical analysis \parencite{ren:finetuning,ren:learning-path},
and practical uses \parencite{mohamadi:active-ntk}.
Work with related tools has also contributed to understanding the grokking phenomenon (a hotly-studied problem in learning theory) \new{\parencite{mohamadi:grokking}},
and to deepen foundational understanding of learning theory in high-dimensional regimes
\changed{\parencite{zhou:optimistic-rates}} \parencite{zhou:moreau,koehler:gaussian-interpolators}.

\paragraph{Improved techniques based on theoretical insights.}
Our theoretical insights have also led to improved models for
learning on graph data (such as molecular graphs and citation networks) \new{\parencite{shirzad:exphormer,shirzad:sparsifying-exphormer}},
private generative models \new{\parencite{harder:dp-mepf,yang:dp-ntk}},
...
\begin{itemize}[leftmargin=5em]
  \item[2024] Conference reviewing: \continuing{ICML, ICLR}.
