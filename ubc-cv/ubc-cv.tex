...
\begin{itemize}[leftmargin=5em]
  ...
  \item[2023] \new{Ad-hoc faculty recruiting committee (single candidate).}
  \item[2023--24] \continuing{AIM-SI Steering Committee (temporary position as a leave replacement).}
...
\begin{itemize}[leftmargin=5em]
  ...
  \item[2023--24] \new{Assistance with the AIM-SI recruiting committee in Statistics, to help avoid conflicts of interest.}
