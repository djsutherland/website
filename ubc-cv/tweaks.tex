...
\newenvironment{suptable}{
  \begin{center}
    \begin{longtable}{ p{0.26\textwidth} p{0.24\textwidth} p{0.075\textwidth} p{0.075\textwidth} p{0.27\textwidth} }
      %% The header for the top of the table
      \toprule
      \multicolumn{1}{c}{\bf Student} & \multicolumn{1}{c}{\bf Program} & \multicolumn{1}{c}{\bf Start} & \multicolumn{1}{c}{\bf Finish} 
      % & \multicolumn{1}{c}{\bf Supervisory Role}
      & \multicolumn{1}{c}{\bf Co-supervisors}
      \\
      % \cmidrule(lr){3-4}
...
\newenvironment{usuptable}{
  \begin{center}
    \begin{longtable}{ p{0.22\textwidth} p{0.52\textwidth} p{0.075\textwidth} p{0.075\textwidth}}
      %% The header for the top of the table
      \toprule
      \multicolumn{1}{c}{\bf Student} & \multicolumn{1}{c}{\bf Program} & \multicolumn{1}{c}{\bf Start} & \multicolumn{1}{c}{\bf Finish} 
      % & \multicolumn{1}{c}{\bf Supervisory Role}
...
%% --------------------
%% Bib related
\usepackage[backend=biber,sorting=none,style=numeric,citestyle=numeric,maxbibnames=12,giveninits=false,defernumbers=true,url=false]{biblatex}
...
\defbibfilter{prep}{
  ( keyword=preprint or keyword=private ) and not keyword=submission
}
...
\renewcommand*{\mkbibcompletename}[1]{%
    \ifitemannotation{me}%
        {\textcolor{orange!70!black}{\ifitemannotation{student}{\underline{#1}}{#1}}}%
        {\ifitemannotation{mystudent}%
            {\textbf{\underline{#1}}}%
            {\ifitemannotation{student}{\underline{#1}}{#1}}}%
...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map{ % arinfo => usera, to not have to modify data model
      \step[fieldsource=arinfo]
      \step[fieldset=usera,origfieldval]
    }
    \map{ % citesrounded => userb
      \step[fieldsource=citesrounded]
...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map[overwrite]{ % strip eprint (arXiv) info from published papers
      \step[fieldsource=keywords,notmatch=\regexp{submission|tech-report},final]
      \step[fieldset=eprint,fieldvalue=]
    }
    \map{ % collabinfo => abstract
...
\DeclareFieldFormat{userb}{\citestext{$\ge$ #1}}
...
\renewbibmacro*{date}{%
  \iffieldundef{month}
    {\printdate}
    {\printfield{month}\setunit{\addspace}\printfield{year}}}

%\renewbibmacro*{date+extradate}{%
%  \iffieldundef{month}
%    {\printdateextra}
%    {\printfield{month}\setunit{\addspace}\printfield{year}\printfield{extradate}}}
