...
\usepackage[maxbibnames=20,doi=false,url=false,sorting=ydnt,style=authortitle,giveninits=true,eprint=false,uniquename=init,dashed=false]{biblatex}
...
%In \cite{sutherland:opt-mmd} (where I was lead author) and then followed up 
...
often %combining students' suggestions with my ideas in a way
